...
public class VolleyOpenHelper extends SQLiteOpenHelper{
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("create table dt_chatMessenger(id_message integer autonumeric, message text, username text,friend_username text, date_register text, hour text)");
	...
	public void onUpgrade(SQLiteDatabase db, int versionAnte, int versionNue) {
		...
		db.execSQL("create table dt_users(username text primary key, password text, fullname text, verification_code text)");		
		db.execSQL("create table dt_friends(id_friend int autonumeric, friend_username text, name text)");
		db.execSQL("create table dt_chatMessenger(id_message integer autonumeric, message text, username tesxt,friend_username text, date_register text, hour text)");
	}	
}
